---
Tags: exercise
Created: 2026-01-22 23:50:31
---
(Links:: [[Network Security]])
# Exercise sheet 13: Anonymity (27 points)

### Question 1 (2 points)
**ACS anonymity set.**
Alice and Bob are communicating using an anonymous
...
Other attack-based solutions valid.
...
immediately or periodically forget all the cookies. See [Cookie Auto
Delete](https://github.com/Cookie-AutoDelete/Cookie-AutoDelete) for an
example.  By default Tor
...
_Solution_:
Probably yes. The global percentage is something between 83% - 96% according to [1].

[1]: https://arxiv.org/pdf/1905.01051.pdf
...
> privacy by encouraging opaque techniques such as fingerprinting." [2] .
> Google main source of income is advertising, and their position is
> understandable [3] – nevertheless, blaming privacy-conscious users for
...
> [3] <https://services.google.com/fh/files/misc/disabling_third-party_cookies_publisher_revenue.pdf>
