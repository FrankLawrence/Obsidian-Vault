...
- Network layer transmits packets across the network from a source host to a destination host and provides [[University/Vrije/Advanced Network Programming/Congestion Control|congestion control]] with transport layer
